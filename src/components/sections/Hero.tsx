...
const Hero = () => {
  ...
  const profileImages = [
    '/images/jihedhero.jpg',
    '/images/ozama.jpg',
    '/images/bebo.jpg',
    '/images/fallenleaf.jpg'
  ]
  ...
  }, [controls, isDeleting, loopNum, text, typingSpeed])
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="lg:w-1/2 space-y-8 text-center lg:text-left">
            ...
            >
              {[
                { icon: Github, href: 'https://github.com/jihed333', label: 'GitHub' },
                { icon: Linkedin, href: 'https://www.linkedin.com/in/hagui-jihed-96001b260/', label: 'LinkedIn' },
                { icon: Mail, href: 'mailto:jihed.hagui7@gmail.com', label: 'Email' }
              ].map((social, index) => (
                <motion.a
                  key={index}
                  href={social.href}
